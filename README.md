...
Raw gene count data were log-transformed and Principal Component Analysis (PCA) was applied to reduce dimensionality. Each point in the PCA plot represents one individual sample, and samples are colored by condition (Healthy vs MS post-treatment).
